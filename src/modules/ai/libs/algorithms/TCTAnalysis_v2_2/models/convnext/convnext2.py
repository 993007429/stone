...
class Modeling_Convnext(nn.Module):
    def __init__(self,):
        ...
        # self.model = timm.create_model('convnext_tiny', pretrained=False, num_classes=0)
        self.model = convnext_tiny(pretrained=False, num_classes=0)
