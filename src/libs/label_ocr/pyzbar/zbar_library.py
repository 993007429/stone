    ...
    if 'Windows' == platform.system():
        ...
        def load_objects(directory):
            ...
            deps = [
                ...
                cdll.LoadLibrary(os.path.join(os.path.dirname(os.path.abspath(__file__)), dep))
                for dep in dependencies
            ]
            # libzbar = cdll.LoadLibrary(str(directory.joinpath(fname)))
            libzbar = cdll.LoadLibrary(os.path.join(os.path.dirname(os.path.abspath(__file__)), fname))
            return deps, libzbar
